      var background = "img/bareng ega 1.jpeg";
      var foto = "img/bareng ega 2.jpeg";
      var musik = "https://dekatutorial.github.io/Gellen%20Martadinata%20-%20Selamat%20Ulang%20Tahun.mp3";
      var panggilan = "NENG EGA OKTAVIA";
      var ucapan = "Sebelum neng baca aa minta maaf ya baru aa kirim kado sekarang :) :V Hitung hidupmu dari tawa, bukan air mata. Hitung usiamu dari pertemanan, bukan tahun. Selamat ulang tahun";

      var hadiah1 = "HADIAH NYA AA BUAT DENGAN PENUH KASIH DAN RASA SAYANG BEGITU INDAH, DI BUKA YA HEHEHE :)";
      var hadiah2 = "JANGAN MENYERAH NENG TERUS SEMANGAT YA HEHEH :)";
      var hadiah3 = "HADIAH NYA AA BUAT DENGAN PENUH KASIH DAN RASA SAYANG BEGITU INDAH, DI BUKA YA HEHEHE :)";
      var hadiah4 = "JANGAN MENYERAH NENG TERUS SEMANGAT YA HEHEH :)";

      var noWhatsapp = "6285695620052";
    ...
    hai.innerHTML = panggilan; open.style = "background: linear-gradient(to right, rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('" + background + "');background-size: cover;"; 
    bg.style = "background: linear-gradient(to right, rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('" + background + "');background-size: cover;";
  ...
  function typeWriter() { 
    if (i < txt.length) { 
      pesanku.innerHTML += txt.charAt(i); i++; 
  ...
  async function balas() { 
    var { value: pesan } = await swalo.fire({ 
      title: "Tulis pesan Ya Cantik :)", input: "text", 
      confirmButtonText: "Kirim", 
    }); 
    if (pesan) { 
      await swalo.fire("Kirim ke wa aku ya jawaban nya"); 
      location.assign("https://api.whatsapp.com/send?phone=" + noWhatsapp + "&text=Hai, aku dapet " + hadiah + ".%0A %0AAku mau bilang, " + pesan); 
      modal.style = "top: 60vh;opacity: 0;display: flex;"; 
      setTimeout(function () { 
        modal.style = "display: none;"; 
      }, 300); 
